...
The agent you create owns its own tool registry, provider, and store backend — you bring your own Postgres database, your own auth, your own framework. Amodal stays invisible to your end users.
