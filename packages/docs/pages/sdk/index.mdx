---
description: React SDK for embedding Amodal agents — @amodalai/react components and @amodalai/chat-widget.
---
...
- **[@amodalai/chat-widget](/sdk/chat-widget)** — Standalone chat widget with SSE streaming, theming, and callbacks.
