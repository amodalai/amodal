...
**Context injection:** Connection specs support a `contextInjection` map to automatically forward scope context values (passed with the request) into API calls — as query params, headers, path variables, or body fields.
