    ...
    <div className="p-8 max-w-2xl">
            ...
            return (
              <div key={s.name} className="flex items-center gap-3">
                ...
                <div className="flex-1 h-2 bg-gray-200 dark:bg-zinc-800 rounded-full overflow-hidden">
                  <div className="h-full bg-indigo-400/60 rounded-full" style={{ width: `${String(pct)}%` }} />
                </div>
      ...
      <div>
        <button
          ...
          className="flex items-center gap-2 text-sm text-gray-600 dark:text-zinc-400 hover:text-indigo-600 dark:hover:text-indigo-400 transition-colors mb-3"
        >
