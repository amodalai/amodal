...
export function ConfigSystemPage() {
  ...
  if (!info) return <div className="p-8 text-gray-400 dark:text-zinc-500 text-sm">Loading...</div>;

  return (
    <div className="p-8 max-w-2xl">
      <h1 className="text-lg font-semibold text-gray-900 dark:text-zinc-200 mb-6">System</h1>
...
function InfoRow({ icon, label, value, mono }: { icon: React.ReactNode; label: string; value: string; mono?: boolean }) {
  return (
    <div className="flex items-center gap-3 border border-gray-200 dark:border-zinc-800 rounded-lg px-4 py-3">
