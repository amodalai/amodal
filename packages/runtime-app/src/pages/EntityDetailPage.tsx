    ...
    <div className="h-full bg-background">
      <div className="max-w-[900px] mx-auto px-6 pt-8 pb-12">
        <button
          ...
          className="flex items-center gap-1.5 text-sm text-muted-foreground hover:text-primary dark:hover:text-primary mb-5 transition-colors"
        >
        ...
        {isLoading ? (
          ...
          <div className="flex items-center justify-center py-16 text-muted-foreground text-sm">Document not found.</div>
        ) : (
          <EntityDetail
