...
- 94d2b0d: Allow `amodal.json#packages` entries to opt into a subset of a multi-role package via `use:`.
...
- [#284](https://github.com/amodalai/amodal/pull/284) [`075ff2b`](https://github.com/amodalai/amodal/commit/075ff2b03c9eb20d294469cd9b0dbf86d70d3ad7) Thanks [@gte620v](https://github.com/gte620v)! - Restore admin agent file tools with draft workspace integration
...
- [#251](https://github.com/amodalai/amodal/pull/251) [`39c3697`](https://github.com/amodalai/amodal/commit/39c36976ef8a6402897272128b1e9d62bbd3a470) Thanks [@gte620v](https://github.com/gte620v)! - Wire buildCredentialResolver into connection loading for scope:KEY resolution
...
- [#245](https://github.com/amodalai/amodal/pull/245) [`fd36345`](https://github.com/amodalai/amodal/commit/fd36345e06c7d7a914c205663481042d333ac6ba) Thanks [@whodatdev](https://github.com/whodatdev)! - Add AUTH_TOKEN env var for simple bearer token auth. When set, chat and session endpoints require `Authorization: Bearer {token}`. When not set, no auth (local dev). Hosting layers that inject their own auth middleware override this.
